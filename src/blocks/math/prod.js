(function(root){
    root.blocks.prod = function(start_line_buf, limit_line_buf){
        var self = {};
        ...
        this.get_block_name = function(){ return 'prod'; };
    ...
    root.blocks.prod.prototype = root.blocks.abstract_block;

    root.blocks.prod.test = function(alpha) { return /^\\prod/.test(alpha); };

    root.blocks.prod.build = function(alpha){
        ...
        return [alpha.substring(block_length + start_length + limit_length + px), new root.blocks.prod((new root.line_buf()).append(start_param), (new root.line_buf()).append(limit_param))];
    };
